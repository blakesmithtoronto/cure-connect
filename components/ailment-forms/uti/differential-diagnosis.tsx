    ...
    <div className="space-y-4">
      <div>
        ...
        <div className="flex items-center space-x-2">
          ...
          <Label htmlFor="systemicSymptoms">
            Systemic symptoms (e.g. fever, chills, extreme fatigue)
          </Label>
        </div>
      </div>
      <div>
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="urologicAbnormalities">
              Patients with underlying urologic abnormalities (e.g. stents,
              urinary diversions)
            </Label>
          </div>
