    ...
    <Card className="mb-6">
      ...
      <CardContent>
        <div className="space-y-4">
          <div>
            <Label>Based on the information gathered from this patient assessment, the patient was referred to a health care provider:</Label>
            <RadioGroup>
              ...
              <div className="flex items-center space-x-2">
                <RadioGroupItem value="emergencyDepartment" id="emergencyDepartment" />
          ...
          <div>
            <Label htmlFor="referralRationale">Rationale for referral / additional information</Label>
